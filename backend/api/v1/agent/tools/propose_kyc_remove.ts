...
import { ProposeKycRemoveDtoSchema } from '../../../../src/application/dto/agent/issuer-tool.dto.js';
...
const handler = createHandler({
  operationName: 'AgentToolProposeKycRemove',
  schema: ProposeKycRemoveDtoSchema,
