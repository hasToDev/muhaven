...
# delivered (`notify=ok|fail`) so a follow-up heartbeat / monitor can
# detect "the alert path itself broke".
#
...
check_partial_scrape() {
  ...
  # exit (see development/ORACLE_DATA_MINE/scripts/refresh-all.ts
  # appendHistory) of the form:
  #
